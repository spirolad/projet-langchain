# Cet outil effectue des calculs financiers courants : TVA, intérêts composés, marge commerciale, et mensualités de prêt. Il accepte des paramètres séparés par des virgules.
